...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	return (CaloriesWeightMultiplier*w.Weight + math.Pow(w.meanSpeed()/KmHInMsec, 2)/w.Height*CaloriesSpeedHeightMultiplier) * w.Duration.Hours() * MinInHours
}
